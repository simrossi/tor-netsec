...
if [ "$#" -ne 3 ]; then
    echo "Usage: $0 <relay_addr> <relay_name> <pkgs_directory>"
    exit 1
fi
...
# Setting static ip
sudo nmcli c mod "Wired connection 1" ipv4.addresses $relay_addr/16 ipv4.method manual
